...
/**
 * Adds Example_Subs widget.
 **/
class Example_Subs_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'examplesubs_widget', // Base ID
			esc_html__( 'Example Subs', 'exam_domain' ), // Name
			array( 'description' => esc_html__( 'A Foo Widget', 'exam_domain' ), ) // Args
		);
	}
